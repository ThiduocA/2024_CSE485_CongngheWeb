                ...
                <div class="row">
                    <div class="col-md-4">
                        ...
                        <div class='text-center mt-3'>
                            ...
                            <button type="button" class="btn btn-primary mt-2" id="choose-image-btn">Chọn Avatar</button>
                        </div>
                    </div>
                    <div class="col-md-8 mt-4">
                        <form id="employee-form" action="EmployeeController.php" method="post" enctype="multipart/form-data" class="needs-validation border p-4 shadow-xl" novalidate>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select class="form-select" name = 'department_Name' aria-label="Default select example">
                                        ...
                                        <?php foreach ($departmentName as $index => $item) : ?>
                                            <?php if ($index === 0) : ?>
                                                <option value="<?php echo $item['departmentName']; ?>" selected><?php echo $item['departmentName']; ?></option>
                                            <?php else : ?>
                                                <option value="<?php echo $item['departmentName']; ?>"><?php echo $item['departmentName']; ?></option>
                                            <?php endif; ?>
                                        <?php endforeach; ?>
                                    </select>
                                </div>
