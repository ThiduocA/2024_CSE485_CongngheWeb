    ...
    <div class="container" style='width: 80vw'>
        <div class="row">
            <div class="col-md">
                ...
                <a href="<?= domains.'index.php?controller=department&action=add'?>" class='btn btn-primary'>Thêm
                    mới</a>
                ...
                <table class="table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="<?= domains.'index.php?controller=department&action=delete&id='. $department->getDepartmentID();?>"
