...
class EmployeeService
{
    ...
    public function editInfo($id, $fullname, $mobilePhone, $address, $position, $email, $avatar)
    {
        $conn = connectDB();
        $sql = "Update employees set fullname = '$fullname', address = '$address', email = '$email', mobilephone = '$mobilePhone', position = '$position', avatar = '$avatar' where employeeID = '$id'";
